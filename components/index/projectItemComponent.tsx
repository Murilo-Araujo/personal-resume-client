...
export default function ProjectItemComponent({project}: ProjectItemComponentProps) {
    ...
    return (
        <Link href={`/project/${project.id}`} className="h-full p-6 rounded-lg shadow border-4 border-black my-4 group cursor-pointer -wave_animation hover:shadow-lg w-96 hover:border-white hover:bg-black hover:text-white transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-100">
