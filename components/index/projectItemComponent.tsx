...
export default function ProjectItemComponent({project}: ProjectItemComponentProps) {
    ...
    return (
        <div className="h-60 p-6 snap-center rounded-lg shadow border-4 border-black my-4 group -wave_animation hover:shadow-lg w-96 hover:bg-black hover:text-white transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-100">
